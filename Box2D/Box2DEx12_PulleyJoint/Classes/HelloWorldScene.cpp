...
bool HelloWorld::createBox2dWorld(bool debug) {
	...
	b2PulleyJointDef pullyJointDef;

	b2Body *body1 = this->addNewSprite(Vec2(250, 150), Size(40, 40), b2_dynamicBody, "test", 0);
	b2Body *body2 = this->addNewSprite(Vec2(300, 150), Size(40, 40), b2_dynamicBody, "test", 0);

	b2Body *bodyA = this->addNewSprite(Vec2(200, 300), Size(40, 40), b2_staticBody, nullptr, 0);
	b2Body *bodyB = this->addNewSprite(Vec2(300, 300), CCSizeMake(40, 40), b2_staticBody, nullptr, 0);

	pullyJointDef.Initialize(body1, body2,
		b2Vec2(200/PTM_RATIO, 300/PTM_RATIO),
		b2Vec2(300 / PTM_RATIO, 300 / PTM_RATIO),
		body1->GetPosition(),
		body2->GetPosition(),
		1);
	//약 160 ... 200이라 중력의 영향으로 아래도 떨어졌다
	pullyJointDef.lengthA = 160 / PTM_RATIO;
	pullyJointDef.lengthB = 160 / PTM_RATIO;
	pullyJointDef.collideConnected = true;

	_world->CreateJoint(&pullyJointDef);
