...
bool HelloWorld::createBox2dWorld(bool debug) {
	...
	b2Body *body1, *body2;
	b2DistanceJointDef disJoinDef;
	//b2RevoluteJoint *disJoint;

	body1 = this->addNewSprite(Vec2(240, 280), Size(60, 60), b2_dynamicBody, "test", 0);
	body2 = this->addNewSprite(Vec2(340, 280), Size(40, 40), b2_dynamicBody, "CloseNormal.png", 0);

	disJoinDef.Initialize(body1, body2,
		b2Vec2(body1->GetPosition().x, body1->GetPosition().y),
		b2Vec2(body2->GetPosition().x, body2->GetPosition().y));
	_world->CreateJoint(&disJoinDef);
