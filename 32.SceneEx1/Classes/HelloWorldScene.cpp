...
bool HelloWorld::init()
{
    ...
    /////////////////////////////
	auto item1 = MenuItemFont::create("push Scene", CC_CALLBACK_1(HelloWorld::doPushScene, this));
	item1->setColor(Color3B::BLACK);

	auto item2 = MenuItemFont::create("do Push Scene Tran", CC_CALLBACK_1(HelloWorld::doPushSceneTran, this));
	item2->setColor(Color3B::BLACK);

	auto item3 = MenuItemFont::create("do Replace Scene", CC_CALLBACK_1(HelloWorld::doReplaceScene, this));
	item3->setColor(Color3B::BLACK);

	auto item4 = MenuItemFont::create("do Replace Scene Tran", CC_CALLBACK_1(HelloWorld::doReplaceSceneTran, this));
...
void HelloWorld::doReplaceSceneTran(Ref* pSender) {
	static int num2 = 0;
	auto pScene = TestScene2::createScene();
	log("%d  Scene Tran", num2);
	Director::getInstance()->pushScene(createTransition(num2++, 1, pScene));
}
